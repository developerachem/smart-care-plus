...
import NewRecord from './gyn-obs/NewRecord';
import GynPastRecord from './gyn-obs/PastRecord';

const GynObsHistories = () => {
        ...
        <div>
            <div className="text-sm font-medium breadcrumbs overflow-hidden mt-5">
                <ul>
                    ...
                    <li className='text-buttonColor hover:text-buttonColorHover'> <a>Gyn & Obs</a></li> 
...
export default GynObsHistories;