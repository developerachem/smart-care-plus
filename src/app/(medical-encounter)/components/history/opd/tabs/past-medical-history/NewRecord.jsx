    ...
    return (
        <div>
            ...
            <div className="bg-white shadow-md dark:bg-whiteDark rounded-md mt-3">
                ...
                <div className="p-6">
                    <div className="">
                        <Textarea label="Drug History" className='min-h-10' required />
                    </div>
                    <div className="mt-6">
                        <Textarea label="Admission History" className='min-h-10' required />
                    </div>
                    <div className="mt-6">
                        <Textarea label="Surgical History" className='min-h-10' required />
                    </div>
                </div>
            </div>
